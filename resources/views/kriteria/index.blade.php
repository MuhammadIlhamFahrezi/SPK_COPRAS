<!-- views/kriteria/index.blade.php -->
@extends('layouts.app')
                    ...
                    <div>
                        <table class="w-full border-2 border-gray-300 text-center">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="6" class="px-4 py-2 border text-center text-gray-500 font-semibold italic">
                                        @if(request('search'))
                                        Tidak ada data kritria yang cocok dengan pencarian "{{ request('search') }}"
                                        @else
...
<div id="deleteModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center hidden z-50">
    <div class="bg-white p-8 rounded-md shadow-lg max-w-lg w-full space-y-6">
        ...
        <div class="border-t border-b py-6">
            <p class="text-gray-600">Apakah Anda yakin ingin menghapus kriteria <span id="deleteItemName" class="font-bold"></span>?</p>
        </div>
